...
<div class="main w1210 bc mt10">
    ...
    <div class="content fl ml10">
        ...
        <div class="address_bd mt10">
            <h4>新增收货地址</h4>
            <form id="signupForm" action="<?=\yii\helpers\Url::to(['ress/edit'])?>" name="address_form" method="post">
                <ul>
                    <li>
...
s
                    ...
                    <li>
                        <label for="">&nbsp;</label>
                        <input type="checkbox" name="remember" class="check" <?=$model->status?'checked':''?> />设为默认地址
                    </li>
                    <li>
                        <label for="">&nbsp;</label>
...
<script type="text/javascript" >
    ...
    $().ready(function() {
        addressInit('cmbProvince', 'cmbCity', 'cmbArea','','<?=$model->province?>','<?=$model->city?>','<?=$model->county?>');
// 在键盘按下并释放及提交后验证提交表单
        $("#signupForm").validate({
            rules: {
                name: {
