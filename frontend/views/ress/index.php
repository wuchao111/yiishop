...
<div class="main w1210 bc mt10">
    ...
    <div class="content fl ml10">
        <div class="address_hd">
            ...
            <h3>收货地址薄    <a href="<?=\yii\helpers\Url::to(['ress/add'])?>">添加地址</a></h3>


            <?php $num=1;?>
            <?php foreach ($models as $model):?>
            <dl>
                <dt><?=$num?>.<?=$model->name?> <?=$model->province?>  <?=$model->city?> <?=$model->county?> <?=$model->address?> <?=$model->tel?></dt>
                <dd>
                    <a href="<?=\yii\helpers\Url::to(['ress/edit','id'=>$model->id])?>">修改</a>
                    <a href="<?=\yii\helpers\Url::to(['ress/delete','id'=>$model->id])?>">删除</a>
                    <?php if(!$model->status):?>
                    <a href="<?=\yii\helpers\Url::to(['ress/statues','id'=>$model->id])?>" >设为默认地址</a>
                    <?php endif; ?>
                </dd>
            </dl>
                <?php $num++;?>
