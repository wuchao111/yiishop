...
<form method="post" action="<?=\yii\helpers\Url::to(['goods/place-order'])?>">
<!-- 主体部分 start -->
<div class="fillin w990 bc mt15">
    ...
    <div class="fillin_bd">
        ...
        <div class="address">
            ...
            <div class="address_info">
                ...
                <p><input type="radio" value="<?=$ress->id?>" name="address_id"/><?=$ress->name?>  <?=$ress->tel?>  <?=$ress->province?> <?=$ress->city?> <?=$ress->county?> </p>
                <?php endforeach;?>
                <a href="<?=\yii\helpers\Url::to(['ress/add'])?>">添加地址</a>
            </div>
        ...
        <div class="pay">
            ...
            <div class="pay_select">
                <table>
                    ...
                    <tr  class="cur">
                        <td class="col1"><input type="radio" name="pay" checked="checked" value="2"/>在线支付</td>
        ...
        <div class="goods">
            ...
            <table>
                ...
                <tbody>
                <?php $price_all = 0?>
                <?php foreach ($good as $goods=>$amount):?>
                    <?php $goodss = \backend\models\Goods::findOne(['id'=>$goods])?>
                    <?php $price = $goodss->shop_price * $amount?>
                    <?php $price_all += $price?>
                <tr>
                    <td class="col1"><a href=""><img src="<?=$goodss->logo?>" alt="" /></a>  <strong><a href=""><?=$goodss->name?></a></strong></td>
                    <td class="col3">￥<?=$goodss->shop_price?></td>
                    <td class="col4"> <?=$amount?></td>
                    <td class="col5"><span>￥<?=$price ?></span></td>
                </tr>
                <?php endforeach;?>
                </tbody>
                <tfoot>
    ...
    <div class="fillin_ft">
        <button href="javascript:;" id="but"><span >提交订单</span></button>
        <p>应付总额：<strong>￥<?=$price_all ?>元</strong></p>
    </div>
...
<script type="text/javascript">
    $("#but").click(function () {
        ...
        var val2= $('.delivery_select input:checked').val();
        var val1= $('.address_info input:checked').val();
        console.debug(val1)
