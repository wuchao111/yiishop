    ...
    <div class="content fl ml10">
        ...
        <div class="order_bd mt10">
            <table class="orders">
                ...
                <tbody>
                <?php $arr=[0=>'已取消',1=>'代付款',2=>'代发货',3=>'代收款',4=>'完成']?>
                <?php foreach ($orders as $order):?>

                    <?php $goods = \app\models\OrderGoods::find()->where(['order_id'=>$order->id])->limit(3)->all()?>
...
<script type="text/javascript">
    $('.del').click(function () {
        ...
        $.get('/goods/delete.html',{order_id:order_id},function (arr) {
            if(arr == 'success'){
                tr.remove()
            }else {
                alert('删除失败 ')
