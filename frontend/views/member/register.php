...
<div class="login w990 bc mt10 regist">
    ...
    <div class="login_bd">
        <div class="login_form fl">
            <form id="signupForm" action="<?=\yii\helpers\Url::to(['member/register'])?>" method="post">
                <ul>
                    <li>
                        <label for="">用户名：</label>
        ...
        $("#signupForm").validate({
            rules: {
                name: {
                    ...
                    minlength: 2,
                    //远程异步验证
                    remote: "<?=\yii\helpers\Url::to(['member/validate'])?>"
                },
                password_hash: {
                    required: true,
                    minlength: 6
