            ...
            <div class="preview fl">
                <div class="midpic">
                    <a href="<?=$goods->logo?>" class="jqzoom" rel="gal1"  ><!-- 第一幅图片的大图 class 和 rel属性不能更改 -->
                        <img src="<?=$goods->logo?>" alt="" style="width: 350px"/>               <!-- 第一幅图片的中图 -->
                    </a>
                </div>
                ...
                <div class="smallpic">
                    ...
                    <div class="smallpic_wrap">
                        <ul>
                            ...
                            <li>
                                <a href="javascript:void(0);" rel="{gallery: 'gal1', smallimage: '<?=$path->path?>',largeimage: '<?=$path->path?>'}"><img src="<?=$path->path?>"></a>
                            </li>
                            <?php endforeach;?>
                        </ul>
            ...
            <div class="detail_bd">
                ...
                <div class="introduce detail_div none">
                    ...
                    <div class="desc mt10">
                        ...
                        <img src="/images/desc2.jpg" alt="" style="width: 350px"/>
