    ...
    <div class="nav w1210 bc mt10">
        ...
        <div class="category fl"> <!-- 非首页，需要添加cat1类 -->
            ...
            <div class="cat_bd">
                ...
                <div class="cat item1">
                    <h3><a href="<?=\yii\helpers\Url::to(['member/goods','id'=>$good->id])?>"><?=$good->name?></a> <b></b></h3>
                    <div class="cat_detail">
                        <?php $parent = \backend\models\GoodsCategory::find()->where(['parent_id'=>$good->id])->all()?>
                        <?php foreach ($parent as $child):?>
                        <dl class="dl_1st">
                            <dt><a href="<?=\yii\helpers\Url::to(['member/goods','id'=>$child->id])?>""><?=$child->name?></a></dt>
                            <?php $parents = \backend\models\GoodsCategory::find()->where(['parent_id'=>$child->id])->all()?>
                            <?php foreach ($parents as $childs):?>
                            <dd>
                                <a href="<?=\yii\helpers\Url::to(['member/goods','id'=>$childs->id])?>"><?=$childs->name?></a>
                            </dd>
                                <?php endforeach;?>
                        </dl>
                        <?php endforeach;?>
    ...
    <div class="guide_content fl">
        ...
        <div class="guide_wrap">
            ...
            <div class="crazy">
                ...
                <?php foreach ($goodss as $goodes): ?>
                <ul>
                    <li>
                        <dl>
                            <dt><a href=""><img src="<?=$goodes->logo?>" alt="" /></a></dt>
                            <dd><a href=""><?=$goodes->name?></a></dd>
                            <dd><span>售价：</span><strong> ￥<?=$goodes->shop_price?></strong></dd>
                        </dl>
                    </li>
                </ul>
                <?php endforeach; ?>
            ...
            <div class="hot none">
                ...
                <?php foreach ($parent as $child): ?>
                    <ul>
                        <li>
                            <dl>
                                <dt><a href=""><img src="<?=$child->logo?>" alt="" /></a></dt>
                                <dd><a href=""><?=$child->name?></a></dd>
                                <dd><span>售价：</span> <strong>￥<?=$child->shop_price?></strong></dd>
                            </dl>
                        </li>
                    </ul>
                <?php endforeach;?>
            ...
            <div class="recommend none">
                <?php $good = \backend\models\Goods::find()->where(['>','id',6])->andwhere(['<','id',11])->all()?>
